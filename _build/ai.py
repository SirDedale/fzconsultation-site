...
AI_PAGES = [
 {
  ...
  "cover": [
    (("Atelier de vision", "Vision workshop"), ("Nous animons un atelier qui aligne la direction sur les objectifs, les limites et le niveau d'autonomie acceptable pour vos premiers agents. Cet alignement en amont évite les désaccords tardifs qui font souvent échouer les initiatives d'IA en cours de route.", "We run a workshop that aligns leadership on goals, limits and the acceptable level of autonomy for your first agents. Getting this alignment early avoids the late disagreements that often derail AI initiatives partway through.")),
    (("Portefeuille de cas d'usage", "Use case portfolio"), ("Nous évaluons la valeur, la faisabilité et le risque de chaque idée pour choisir les premières à lancer, plutôt que de partir dans plusieurs directions à la fois. Un portefeuille resserré donne des résultats visibles plus vite qu'une longue liste jamais terminée.", "We score each idea on value, feasibility and risk to choose which ones go first, rather than starting several directions at once. A tighter portfolio delivers visible results faster than a long list that never gets finished.")),
    (("Feuille de route", "Roadmap"), ("Nous séquençons pilotes, fondations de données et gouvernance sur 12 à 18 mois, en tenant compte de vos contraintes budgétaires et de vos échéances réglementaires. La feuille de route reste vivante : elle se révise à chaque jalon plutôt que d'être figée dès le départ.", "We sequence pilots, data foundations and governance over 12 to 18 months, factoring in your budget constraints and regulatory deadlines. The roadmap stays alive: it gets revised at every milestone rather than being fixed from day one.")),
    (("Adoption et formation", "Adoption and training"), ("Nous formons les équipes concernées, aidons à créer une communauté de pratique interne, et mettons en place des indicateurs d'usage réels. L'adoption se mesure à ce que les équipes utilisent vraiment au quotidien, pas au nombre de licences activées.", "We train the relevant teams, help build an internal community of practice, and set up real usage metrics. Adoption is measured by what teams actually use day to day, not by the number of licenses activated.")),
  ],
 ...
 },
 {
  ...
  "cover": [
    (("Conception", "Design"), ("Nous définissons avec les équipes métier les tâches, les outils, les données accessibles et le niveau d'autonomie de chaque agent avant d'écrire la moindre ligne de code. Cette étape évite de construire un agent techniquement impressionnant mais mal aligné sur le besoin réel.", "We define tasks, tools, accessible data and each agent's autonomy level with the business teams before writing a line of code. This step avoids building an agent that is technically impressive but poorly aligned with the real need.")),
    (("Construction", "Build"), ("Nous développons sur la plateforme de votre choix, dont Microsoft Foundry et Copilot Studio, sans vous enfermer dans un seul écosystème. Le choix de la plateforme suit vos contraintes existantes plutôt que nos préférences.", "We build on the platform of your choice, including Microsoft Foundry and Copilot Studio, without locking you into a single ecosystem. The platform choice follows your existing constraints rather than our preferences.")),
    (("Évaluation et tests", "Evaluation and testing"), ("Nous construisons des jeux de tests représentatifs, des tests d'attaque par injection de requêtes, et des mesures de qualité suivies dans le temps. Un agent qui fonctionne une fois en démonstration n'est pas encore un agent prêt pour la production.", "We build representative test sets, run prompt injection attack tests, and track quality metrics over time. An agent that works once in a demo is not yet an agent ready for production.")),
    (("Mise en production", "Production"), ("Chaque agent reçoit une identité propre, une journalisation complète de ses actions, une supervision active et un plan de retour arrière prêt à l'emploi. Ces garde-fous permettent d'augmenter l'autonomie progressivement, à mesure que la confiance se construit.", "Each agent gets its own identity, complete logging of its actions, active monitoring and a ready-to-use rollback plan. These guardrails let you increase autonomy gradually, as trust builds.")),
  ],
 ...
 },
 {
  ...
  "cover": [
    (("Politique d'utilisation", "Acceptable use policy"), ("Nous rédigeons des règles claires pour les employés, les données qu'ils peuvent partager avec un outil d'IA, et la liste des outils autorisés. Cette politique reste courte et compréhensible, pour être réellement suivie plutôt que contournée.", "We write clear rules for staff, the data they can share with an AI tool, and the list of approved tools. The policy stays short and understandable, so it is actually followed rather than worked around.")),
    (("Inventaire et IA non autorisée", "Inventory and shadow AI"), ("Nous recensons les outils et agents d'IA réellement utilisés dans votre organisation, officiels ou non, souvent adoptés par les équipes avant même que la direction ne le sache. Cet inventaire est le point de départ indispensable de toute gouvernance crédible.", "We list the AI tools and agents actually in use across your organization, official or not, often adopted by teams before leadership even knows about them. This inventory is the essential starting point for any credible governance.")),
    (("Classification des risques", "Risk classification"), ("Nous classons vos usages selon le règlement européen sur l'IA et vos propres critères de risque, pour identifier ceux qui exigent une attention particulière. Cette classification guide ensuite le niveau de contrôle et d'approbation requis pour chaque nouveau projet.", "We classify your use cases under the EU AI Act and your own risk criteria, to identify which ones need special attention. This classification then guides the level of control and approval required for each new project.")),
    (("Système de management", "Management system"), ("Nous alignons votre cadre de gouvernance sur ISO/IEC 42001 et le NIST AI RMF, deux référentiels reconnus qui structurent la gestion des risques liés à l'IA. Cet alignement facilite aussi les futures démonstrations de conformité auprès de clients ou d'auditeurs.", "We align your governance framework with ISO/IEC 42001 and the NIST AI RMF, two recognized frameworks that structure AI risk management. This alignment also makes future compliance demonstrations to clients or auditors easier.")),
  ],
...
CITADEL = {
 ...
 "why": [
   (("Des pilotes qui atteignent la production", "Pilots that reach production"), ("Les blocages de sécurité et de conformité sont réglés une fois, au niveau de la plateforme, plutôt que rejoués à chaque nouveau projet d'agent. C'est souvent ce qui fait la différence entre un pilote qui reste un pilote et un déploiement réel.", "Security and compliance blockers are solved once, at platform level, rather than relitigated for every new agent project. This is often what separates a pilot that stays a pilot from a real deployment.")),
   (("Des coûts maîtrisés", "Controlled costs"), ("Chaque appel à un modèle est attribué à une équipe et à un budget précis, ce qui rend les coûts de l'IA aussi visibles que n'importe quelle autre dépense infonuagique. Plus de surprise en fin de mois sur une facture que personne ne peut expliquer.", "Every model call is attributed to a specific team and budget, which makes AI costs as visible as any other cloud spend. No more end-of-month surprises on a bill no one can explain.")),
   (("Une autonomie encadrée", "Autonomy within guardrails"), ("Les équipes innovent vite à l'intérieur de garde-fous communs, sans avoir besoin de contourner les règles pour livrer plus rapidement. C'est ce qui réduit l'IA non autorisée : donner un chemin rapide et légitime plutôt que d'interdire sans alternative.", "Teams move fast inside shared guardrails, without needing to work around the rules to ship faster. This is what actually reduces shadow AI: offering a fast, legitimate path instead of forbidding without an alternative.")),
 ],
 "our": [
   (("Évaluation de préparation", "Readiness assessment"), ("Nous évaluons votre zone d'atterrissage Azure, vos identités, votre réseau, vos quotas de modèles et vos exigences de gouvernance avant de recommander un déploiement. Cette évaluation évite les mauvaises surprises une fois le projet lancé.", "We assess your Azure landing zone, identity setup, networking, model quotas and governance requirements before recommending a deployment. This assessment avoids unpleasant surprises once the project is under way.")),
   (("Conception et politiques", "Design and policies"), ("Nous adaptons l'architecture Citadel à vos risques propres : règles de la passerelle, contrats d'accès par équipe, et classification de vos données. Une architecture de référence reste un point de départ, pas une solution à appliquer telle quelle.", "We adapt the Citadel architecture to your specific risks: gateway rules, per-team access contracts, and classification of your data. A reference architecture is a starting point, not a solution to apply as-is.")),
   (("Déploiement et intégration", "Deployment and onboarding"), ("Nous mettons en place le hub de gouvernance et un premier environnement d'agents, en travaillant directement avec vos équipes Azure plutôt qu'à leur place. L'objectif est de transférer la compétence, pas de créer une dépendance envers nous.", "We deploy the governance hub and a first agent environment, working directly alongside your Azure teams rather than instead of them. The goal is to transfer the skill, not to create a dependency on us.")),
   (("Résilience de la plateforme IA", "AI platform resilience"), ("Nous appliquons à votre plateforme d'IA la même discipline que pour vos systèmes critiques : bascule entre régions, plan de reprise et procédures d'exploitation. Un hub de gouvernance qui tombe en panne arrête toutes les équipes qui en dépendent, pas seulement une application.", "We apply the same discipline to your AI platform as to your critical systems: cross-region failover, a recovery plan and operating procedures. A governance hub that goes down stops every team that depends on it, not just one application.")),
 ],
